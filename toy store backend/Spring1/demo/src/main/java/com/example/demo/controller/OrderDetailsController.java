...
public class OrderDetailsController {
    ...
    // public ResponseEntity<List<OrderDetails>> getOrderDetailsByUserId(@PathVariable Long uid) {
    //     List<OrderDetails> orderDetailsList = orderDetailsService.getOrderDetailsByUserId(uid);
    //     return ResponseEntity.ok(orderDetailsList);
    // }
